...
public class Api {
	...
	public static StopList getTimesFromStop(int stopCode) {
		try {
			HttpResponse<JsonNode> jsonResponse = Unirest
					.post(BASE_URL + TIMES_FROM_STOP_URL)
					.header("accept", "application/json")
					.field("idClient", API_CLIENT_ID)
					.field("passKey", API_PASSKEY)
					.field("idStop", stopCode)
...
//			System.out.println(json);
		    ...
		    final StopList stopList = gson.fromJson(json, StopList.class);
